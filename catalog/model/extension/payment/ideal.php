...
class ModelExtensionPaymentIdeal extends Model
{
    ...
    public function getMethod($address, $total)
    {
        ...
        $checkTable = $this->db->query('show tables like "'. DB_PREFIX .'targetpay_ideal"');
        ...
        if ($status) {
            $method_data = array(
                ...
                'terms' => '<img src="' . $this->config->get('config_ssl') . 'catalog/view/theme/default/image/targetpay/IDE.png" style="height:30px; display:inline">'
            );
        }
